...
async function GrabUserAccount(accountId, profileID, season){
    try {
...
//	var iKDTBHHELLP =  Object.assign({}, Athena.profile.mtx_purchase_history)
	...
	console.log(Athena.profile.mtx_purchase_history)
	var test = Athena.profile.mtx_purchase_history;
...
//JSON.parse(Athena.profile.mtx_purchase_history)[0]["Athena"]
    return Object.assign({},alr, JSON.parse(HELPME))
